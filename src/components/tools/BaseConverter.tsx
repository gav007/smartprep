...
import { AlertCircle, Binary, Copy, RotateCcw } from 'lucide-react'; // Added Binary icon
...
const initialBase: ConversionBase = 'dec';

export default function BaseConverterPage() {
  const [input, setInput] = useState<string>('');
  const [inputBase, setInputBase] = useState<ConversionBase>(initialBase);
