...
import { calculateSubnetDetails, isValidIPv4, ipToBinaryString, cidrToSubnetMask, formatIpBinaryString } from '@/lib/calculator-utils'; // Import cidrToSubnetMask and formatIpBinaryString
